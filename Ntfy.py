...
def publish(topic: str, message: str, title: str = 'No title', priority: int = 3, tags=None,
...
def parse_args():
    parser = argparse.ArgumentParser(
        description='Utility to publish notifications to Ntfy.sh')
    ...
    parser.add_argument('--priority', help='Priority of the message', default=3)
